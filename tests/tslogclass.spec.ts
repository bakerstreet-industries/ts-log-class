...
describe("ts-log-class", () => {
  ...
  it("Should have a property hook called that can return any string based on incoming log properties", () => {
    chai
      .expect(samplePropReturn)
      .to.equal(
        'This is an example: {"className":"MockClass","methodName":"doAsyncStuff","timestamp":null,"arguments":{},"properties":{"prop1":"\\"sweet\\""},"result":{"sample":"output"}}'
      );
  });
